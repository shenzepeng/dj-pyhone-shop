<template>
  <div id="main">
    ...
    <div class="cart-box" id="cart-box">
      <div class="hd"><span class="no2" id="itemsnum-top">{{goods.goods_list.length}}件</span>
      ...
      <div class="fd cle">
        ...
        <div class="fr" id="price-total">
          <p><span id="selectedCount">{{goods.goods_list.length}}</span>件，总价：<span class="red"><strong
            id="totalSkuPrice">￥{{totalPrice}}元</strong></span></p>
        </div>
        <div class="extr">
          <div class="address">
        ...
        <textarea type="text" v-model="post_script" placeholder="留言不可为空, 请在留言注明: 是否自提"
    ...
    data() {
      return {
        ...
        payWrapList: [
          {
            id: 1,
            img: 'http://vueshopstatic.mtianyan.cn/images%5Calipay.jpg'
          }
        ],
        payWrapActive: null,
        addressActive: null,
