<template>
    <div class="sidebar">
        <div class="cate-menu" id="cate-menu">
            <h3 v-if="isObject"><a href=""><strong>{{currentCategoryName}}</strong><i id="total_count">共{{proNum}}件</i></a></h3>
            <dl>
...
.cate-menu dd.current a,.cate-menu dd.current a:hover{color:#A7B9C3;background-color:#f1f1f1}
