...
<div style="margin-top:0px;background: url(http://vueshopstatic.mtianyan.cn/images%5Cregister/loginBg1.jpg)no-repeat">
            ...
            <div class="tab-form">
                <form id="mobile_register_form" autocomplete="off">
                    ...
                    <div class="form-group marb8">
                        <label>手&nbsp;机&nbsp;号</label>
                        <input id="jsRegMobile" name="account" v-model="mobile" type="text" placeholder="请输入您的手机号码" @focus="clearError">
                    </div>
                    <p class="error-text marb8" v-show="error.mobile">{{error.mobile}}</p>
                    <div class="form-group marb8">
                        <label>密&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;码</label>
                        <input id="jsPhoneRegPwd" name="password_m" type="password" v-model="password" placeholder="请输入6-20位非中文字符密码" @focus="clearError">
                    </div>
...
.bg-box{
    background:url(/media/image/gma8Je8L0F.png) no-repeat center center;
}
.login-box{
    width:853px;
    margin:0px auto;
...
.unslider-arrow.prev {
    left: 0;
    background:url(http://vueshopstatic.mtianyan.cn/images%5Cregister/slide_l.png) no-repeat center center;
}
.unslider-arrow.prev:hover {
    background:url(http://vueshopstatic.mtianyan.cn/images%5Cregister/slide_l_1.png) no-repeat center center;
}
.unslider-arrow.next{
    right:0;
    background:url(http://vueshopstatic.mtianyan.cn/images%5Cregister/slide_r.png) no-repeat center center;
}
.unslider-arrow.next:hover{
    background:url(http://vueshopstatic.mtianyan.cn/images%5Cregister/slide_r_1.png) no-repeat center center;
}
.hd-login > h1{
    float:left;
    color:#fff;
...
/*.form-box > .tab > h2.active{*/
    /*border-bottom:3px solid #A7B9D7;*/
    /*color:#333;*/
/*}*/
.form-group{
    position:relative;
