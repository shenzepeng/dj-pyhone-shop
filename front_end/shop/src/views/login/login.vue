...
<style scoped>
  ...
  .other-login a {
    ...
    vertical-align: top;
    margin-right: 10px;
    background: url(http://vueshopstatic.mtianyan.cn/images%5Clogin/other-login-bg.png) center no-repeat;
  ...
  .unslider-arrow.prev {
    left: 0;
    background: url(http://vueshopstatic.mtianyan.cn/images%5Clogin/slide_l.png) no-repeat center center;
  }

  .unslider-arrow.prev:hover {
    background: url(http://vueshopstatic.mtianyan.cn/images%5Clogin/slide_l_1.png) no-repeat center center;
  }

  .unslider-arrow.next {
    right: 0;
    background: url(http://vueshopstatic.mtianyan.cn/images%5Clogin/slide_r.png) no-repeat center center;
  }

  .unslider-arrow.next:hover {
    background: url(http://vueshopstatic.mtianyan.cn/images%5Clogin/slide_r_1.png) no-repeat center center;
  }
  ...
  .form-box > .tab > h2.active {
    border-bottom: 3px solid #A7B9C3;
    color: #333;
  }
