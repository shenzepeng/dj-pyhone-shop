    ...
    <div class="hd_main cle">
      <div class="logo">
        <router-link to="/app/home/index" class="lizi_logo">
          <img src="/media/image/logo_daishu.jpg" alt="dau">
        </router-link>
...
<script>
  ...
  import {goods_list} from "../../store/getters";
  ...
  export default {
    ...
    created() {
      ...
      // 更新store数据
      this.$store.dispatch('setShopList');//获取购物车数
...
<style scoped lang='scss'>
  ...
  .hd_main .intro li {
    ...
    width: 150px;
    height: 46px;
    background: url(http://vueshopstatic.mtianyan.cn/images%5Chead/webintro-ico.png) 0 -9999px no-repeat;
    overflow: hidden
  }
